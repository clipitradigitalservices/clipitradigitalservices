document.addEventListener("DOMContentLoaded", () => {
  ...
  const animatedElements = document.querySelectorAll(
    ".section-header, .service-card, .about-text, .about-image, .feature-item, .contact-wrapper",
  );
  ...
  // Navbar Scroll Effect with glassmorphism class
  ...
  window.addEventListener("scroll", () => {
    ...
    // Navbar enhanced shadow + scrolled class
    if (scrollY > 50) {
